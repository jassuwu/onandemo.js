import type { FrameMap } from "../frame-map.ts";

/**
 * the homage: the classic cat, inlined into every build (ADR-0006). the art
 * descends from the public-domain oneko bitmaps — receipts in NOTICE.md.
 * all 32 cells of the 8×4 sheet, mapped.
 */
export const neko: { sheet: string; frameMap: FrameMap } = {
  sheet:
